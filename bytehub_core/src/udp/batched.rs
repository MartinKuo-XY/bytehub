...
pub struct SockAddrStore {
    ...
    inner: bytehub_io::mmsg::SockAddrStore,
...
impl SockAddrStore {
    pub const fn new() -> Self {
        Self {
            #[cfg(all(target_os = "linux", feature = "batched-udp"))]
            inner: bytehub_io::mmsg::SockAddrStore::new(),
...
mod linux {
    ...
    use bytehub_io::mmsg::{MmsgHdr, MmsgHdrMut};
    use bytehub_io::mmsg::{send_mul_pkts, recv_mul_pkts};

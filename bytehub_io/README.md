...
[![crates.io](https://img.shields.io/crates/v/bytehub_io.svg)](https://crates.io/crates/bytehub_io)
[![Released API docs](https://docs.rs/bytehub_io/badge.svg)](https://docs.rs/bytehub_io)

ByteHub's high performance IO collections.

## Example

```rust
use tokio::net::TcpStream;
use bytehub_io::{bidi_copy, bidi_zero_copy, bidi_copy_buf};
use bytehub_io::{Pipe, CopyBuffer};

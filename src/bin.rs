...
use bytehub::cmd;
use bytehub::conf::{Config, FullConf, LogConf, DnsConf, EndpointInfo};
use bytehub::ENV_CONFIG;
...
fn setup_dns(dns: DnsConf) {
    ...
    bytehub::core::dns::build_lazy(conf, opts);
}

fn setup_transport() {
    #[cfg(feature = "transport")]
    {
        bytehub::core::kaminari::install_tls_provider();
    }
}
...
async fn run(endpoints: Vec<EndpointInfo>) {
    use bytehub::core::tcp::run_tcp;
    use bytehub::core::udp::run_udp;
